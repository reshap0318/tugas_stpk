...
?>
<?php startblock('title') ?> Tugas Besar 3 Grafik Visualisasi <?php endblock() ?>
...
<li class="breadcrumb-item"><a href="#!">3</a>
<?php endblock() ?>

<?php startblock('breadcrumb-title') ?>
Tugas Besar 3 Grafik Visualisasi
<?php endblock() ?>
          ...
          <div class="card-block">
              <div class="row align-items-center">
                  <div class="col-8">
                      ...
                      <h6 class="text-muted m-b-0">Total kategori</h6>
                  </div>
                  <div class="col-4 text-right">
...
<?php startblock('js') ?>
  ...
  <script>
    ...
    var data = [];
    $.ajax({url: "/tugas/view/tb/gv/koneksi.php?aksi=3", dataType: 'json',success: function(result){
