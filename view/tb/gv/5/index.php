...
?>
<?php startblock('title') ?> Tugas Besar 5 Grafik Visualisasi <?php endblock() ?>
...
<li class="breadcrumb-item"><a href="#!">5</a>
<?php endblock() ?>

<?php startblock('breadcrumb-title') ?>
Tugas Besar 5 Grafik Visualisasi
<?php endblock() ?>
...
<?php
  ...
  $sql2 = 'select count(layanan.id) total_layanan from layanan';
  // echo $sql;
  $result = pg_query($sql);
  ...
  <div class="col-xl-4 col-md-6">
      <div class="card">
          <div class="card-block">
              <div class="row align-items-center">
                  <div class="col-8">
                      <h4 class="text-c-blue f-w-600"><?php echo pg_fetch_assoc($result2)['total_layanan']; ?></h4>
                      <h6 class="text-muted m-b-0">Total Layanan</h6>
                  </div>
                  <div class="col-4 text-right">
...
<?php startblock('js') ?>
  ...
  <script>
    ...
    var data = [];
    $.ajax({url: "/tugas/view/tb/gv/koneksi.php?aksi=5", dataType: 'json',success: function(result){
