...
?>
<?php startblock('title') ?> Pemesanan Management <?php endblock() ?>

<?php startblock('breadcrumb-link') ?>
<li class="breadcrumb-item"><a href="#!">Pemesanan Management</a>
<?php endblock() ?>
                ...
                ?>
                  <tr>
                      ...
                      <td style="width:100px">
                        ...
                        <?php } ?>
                        <?php if($hak_akses==1 || $hak_akses==2){ ?>
                        <a href="/tb_pbd_sp/view/management/waktu/edit.php?kode_waktu=<?php echo $data['kode_waktu']; ?>" class="btn btn-primary btn-mini waves-effect waves-light">detail</a>
                        <?php } ?>
                        <?php if($hak_akses==1 || $hak_akses==2){ ?>
